...
import { Twitter, Linkedin, Facebook, Link2, MessageCircle, Check, Share2 } from "lucide-react"
...
export function FloatingSocialShare({ title, url, excerpt }: FloatingSocialShareProps) {

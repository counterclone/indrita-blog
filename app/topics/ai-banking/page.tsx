...
export default function AIBankingPage() {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        ...
        // Filter articles that have the "AI in Banking" category
        const aiArticles = data.filter((article: Article) => 
          Array.isArray(article.category) 
            ? article.category.includes("AI in Banking")
            : article.category === "AI in Banking"
        );
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-4">AI in Banking</h1>
